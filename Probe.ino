...
#define PORT      PORTD       // Output port
#define PORTIN    PIND        // Input port
#define PORT_DIR  DDRD        // Port direction register


//  SPI Mode
//  use these bits on specified PORT
//  must use single port for all bits
...
//  I2C Mode
//  Only 2 lines needed for I2C

#define SCL   2     // I2C clock
#define SDA   3     // I2C data

// used internally by program
...
void setup() {
  ...
  Serial.begin(9600);
  PORT_DIR = 0b00110100;    // only bit 3 is input
  space=20;
  mode=SPIMODE;
  DoSel(STOP);
}
